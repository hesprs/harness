...
4. **Headless browser script** (Playwright / Puppeteer / Agent Browser) — drives the UI, asserts on DOM/console/network.
...
- or a captured artifact (HAR file, log dump, core dump, screen recording with timestamps)
- or permission to add temporary production instrumentation.
...
- [ ] Hypothesis solidified and repro always reproduces (re-run the Phase 1 loop)
